...
@section('content')
    <section class="relative mb-24">
        <div class="bg-gray-100 px-8 pt-16 pb-4 mx-auto">
            <div class="grid mx-4 lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12">
                <div class="mr-auto place-self-center lg:col-span-7">
                    <h1
                        class="max-w-2xl mb-4 text-4xl font-semibold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
                        Temukan Mobil Bekas Berkualitas</h1>
                    <hr class="bg-primary-400 my-8 w-12 h-1">
                    <p class="max-w-2xl mb-6 font-lighpt text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                        Dapatkan beragam pilihan mobil bekas dengan kondisi prima dan harga terjangkau. Penawaran terbatas!
                    </p>

                </div>
            </div>

            <div class="absolute mx-4 buttom-0 rounded bg-white p-4 shadow-lg">
                ...
                <form>
                    <div class="grid gap-6 md:grid-cols-4">
                        <div class="relative flex items-center">
                            ...
                            <select id="tahun"
                                class="block ps-12 py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 appearance-none focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                                <option selected>Tahun rilis</option>
                        ...
                        <button type="submit"
                            class="py-6 text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Submit</button>
                </form>

            </div>
        </div>

        <div class="absolute inset-y-0 right-0 py-8">
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <!-- main Atropos container (required), add your custom class here -->
                <div class="atropos car-atropos">
                    ...
                    <div class="atropos-scale">
                        ...
                        <div class="atropos-rotate">
                            ...
                            <div class="atropos-inner">
                                ...
                                <img src="assets/images/hero-1-bg.png" width="500" alt="background mobil"
                                    data-atropos-offset="5">
                                <img class="absolute top-0" src="assets/images/hero-1.png" alt="gambar mobil"
                                    data-atropos-offset="-5">
                            </div>
                        </div>
                    </div>
    ...
    <section class="bg-white">
        <div class="flex max-w-screen-xl px-4 py-20 mx-auto">
            ...
            <div class="flex justify-between lg:px-32 gap-4">
                <div class="px-8">
                    <div class="bg-gray-100 border border-white p-4 shadow-xl rounded-md inline-flex">
                        <svg class="w-6 h-6 text-primary-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <h3 class="text-md font-bold mt-8 mb-4">Mencari mobil</h3>
                    <p class="text-sm text-gray-500">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Similique
                        excepturi esse</p>
                </div>
                <div class="px-8">
                    ...
                    <h3 class="text-md font-bold mt-8 mb-4">Menghitung rekomendasi</h3>
                    <p class="text-sm text-gray-500">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Similique
                        excepturi esse</p>
                </div>
                <div class="px-8">
                    ...
                    <h3 class="text-md font-bold mt-8 mb-4">Melakukan pemesanan</h3>
                    <p class="text-sm text-gray-500">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Similique
                        excepturi esse</p>
                </div>
            </div>
                        ...
                        <li class="flex gap-4 mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                                    Fugiat officia harum facilis ducimus aliquam alias corrupti quae rerum impedit eligendi
                                    id.</p>
                            </div>
                        </li>
                    @endfor
    ...
    <section id="cta" class="bg-white">
        <div class="relative px-4 py-32 mx-auto max-w-screen-xl">
            ...
            <div class="absolute right-0 top-0 px-32 py-16">
                <div
                    class="rounded-[30px] border-4 border border-black h-[30rem] w-60 bg-[url('/assets/images/preview.jpeg')] bg-contain bg-center shadow shadow-lg">
                </div>
            </div>
        </div>
    </section>
