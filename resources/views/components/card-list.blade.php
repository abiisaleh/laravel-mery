<section class="bg-white">
    <div class="max-w-screen-xl px-4 py-16 mx-auto">
        ...
        <h1 class="text-3xl font-bold text-center">Temukan Mobil Bekas Berkualitas</h1>
        ...
        <div id="default-tab-content">
            <div class="hidden p-4 rounded-lg flex gap-2" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                @for ($i = 0; $i < 4; $i++)
                    {{ $slot }}
                @endfor
            </div>
